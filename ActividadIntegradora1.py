...
df = pd.read_csv("https://drive.google.com/drive/u/0/folders/1Hd2HOFknGccrm11VSdDp5N9-ADkboWvZ/Police_Department_Incident_Reports__2018_to_Present.csv")
...
#neighborhood_input = st.sidebar.multiselect('Neighborhood',
